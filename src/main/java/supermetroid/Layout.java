...
public class Layout {
  public static Map<Point, Trackable> bountyBlaster() throws Exception {
  ...
  public static Map<Point, Trackable> objectives() throws Exception {
    Map<Point, Trackable> trackables = new HashMap<>();
    trackables.put(new Point(0, 0), new BeamTrackable());
    trackables.put(new Point(1, 0), BooleanTrackable.MORPH);
    trackables.put(new Point(2, 0), BooleanTrackable.BOMBS);
  ...
  public static Map<Point, Trackable> standard() throws Exception {
    Map<Point, Trackable> trackables = new HashMap<>();
